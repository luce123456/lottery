...
$(function () {
    ...
    var userArray = [
                     {"Id": "0", "NickName": "Mike" , "photo": "./images/mike.png" , "base": "S"},
                     {"Id": "1", "NickName": "Alily", "photo": "./images/Alily.png", "base": "S"},
                     {"Id": "2", "NickName": "Lucy",  "photo": "./images/lucy.png", "base": "C"},
                     {"Id": "3", "NickName": "Jhon",  "photo": "./images/Jhon.png", "base": "C"},
                     {"Id": "4", "NickName": "Coco",  "photo": "./images/coco.png", "base": "S"}
                    ] //用户列表
    // var userArray2 = [
            ...
            setTimeout(function () {
                ...
                ulBox.animate({'top': _top}, function () {
                    ...
                    ulBox.children('li').each(function () {
                        ...
                        if (parseInt($(this).position().top) == -_top) {
